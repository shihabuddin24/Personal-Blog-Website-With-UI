...
<body class="bg-primary d-flex justify-content-center align-items-center min-vh-100 p-5">
    <div style="bg-transparent" class="container">
        <div class="row justify-content-center">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 mx-auto auth-logo mb-4">
                            ...
                            <a class='logo-light' href='index.html'>
                                <span><h3 class="text-done">Register</h3></span>
                            </a>
                        </div>
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" id="email" placeholder="Enter your email"name="email" value="{{ old('email') }}">
                                @error('email')
                                        <span class="invalid-feedback text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control" type="password" id="password-confirm" placeholder="Confirm password" name="password_confirmation" value="{{ old('password_confirmation') }}">
                            </div>
