...
@section('content')
<x-breadcum slogan="Blogs" subslogan="Create Blogs"></x-breadcum>

<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Create Blogs</h4>
                <div class="row">
                    <div class="col-12">
                        <div class="p-2">
                            <form action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea type="text" id="style_textarea" class="form-control @error('short_description') is-invalid @enderror" placeholder="Enter Short Description Here" name="short_description" cols="30" rows="8"></textarea>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea type="text" id="style_textarea" class="form-control @error('description') is-invalid @enderror" placeholder="Enter Description Here" name="description" cols="30" rows="11"></textarea>
                                        @error('description')
                                            <span class="text-danger"> {{ $message }} </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-2 row">
                                    ...
                                    <div class="col-md-10">
                                        <img id="blog_image" src="{{ asset('uploads/default/demo.jpg') }}" alt="" style="height: 70%; width:20%">
